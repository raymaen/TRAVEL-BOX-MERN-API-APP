          ...
          <div className="row">
            ...
            >
              ...
              <p>
                ...
                Interested to see live photos from your favourite countries / locations ? 
        ...
        <div className="container text-center pt-5 mt-5 pb-5 icons-area">
          <div className="row pl-5 pr-5">
            ...
            <i className="fas fa-camera-retro"></i>
              <h5>Live Webcam Photos</h5>
              <hr />
              <p>
                TRAVELBOX relies on the wonderfull api from webcams.travel.api, to present you with live and reliable webcam footage.
              </p>
            </div>
            <div className="col-md-4">
            <i className="fas fa-database"></i>
              ...
              <hr />
              <p>
              After creating your free account, you can create your own collection of the webcams you like.
              </p>
            </div>
            <div className="col-md-4">
